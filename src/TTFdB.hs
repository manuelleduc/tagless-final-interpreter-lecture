...
tpow :: (MulSYM repr, BoolSYM repr, FixSYM repr, Symantics repr) => repr (Int -> Int -> Int)
...
tpow7 :: (FixSYM repr, BoolSYM repr, MulSYM repr, Symantics repr) => repr (Int -> Int)
tpow7 = lam (\x -> app (app tpow x) (int 7))
tpow72 :: (MulSYM repr, BoolSYM repr, FixSYM repr, Symantics repr) => repr Int
